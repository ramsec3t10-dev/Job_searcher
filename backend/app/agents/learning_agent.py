...
class LearningAgent(BaseAgent):
    async def create_lesson(self, user_id: str, skill: str, topic: str) -> Lesson:
        ...
        raw = await self._call(TaskType.PLANNING, LESSON_GENERATOR.system_prompt, user, 2000)
    ...
    async def create_flashcards(self, user_id: str, skill: str, count: int = 10) -> list[Flashcard]:
        ...
        raw = await self._call(TaskType.EXTRACTION, FLASHCARD_GENERATOR.system_prompt, user, 1500)
