...
class _StubBedrock:
    ...
    async def invoke_model(self, model_id, messages, system=None, max_tokens=1024, temperature=0.4, timeout=None):
        self.calls.append({"model": model_id, "messages": messages, "system": system})
        return {
